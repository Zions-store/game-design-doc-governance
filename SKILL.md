...
- `doc_modules/*.md.tmpl`  - 27 per-document skeletons (applies / owns / not-owns / chapters / boundaries / audit). 22 additional doc names are referenced by genre profiles but lack formal skeletons; these are documented gaps in the scaffold output.
